...
component NormalPostbackInfo as "回传信息规整"
{
    ...
    {
        if test("NormalPostbackInfo_MmpNameInfo", "eq", "Kochava") {
...
"""
        ...
        self.assertEqual(
            ...
            [
                ...
                Token(
                    type=TokenType.STRING_LITERAL,
                    data='"NormalPostbackInfo_MmpName"',
                    source_location=SourceLocation(
                ...
                Token(
                    ...
                    data=",",
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=45
                    ),
                ),
                Token(
                    type=TokenType.WHITESPACE,
                    data=" ",
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=46
                    ),
                ),
                Token(
                    type=TokenType.STRING_LITERAL,
                    data='"eq"',
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=47
                    ),
                ),
                Token(
                    type=TokenType.COMMA,
                    data=",",
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=51
                    ),
                ),
                Token(
                    type=TokenType.WHITESPACE,
                    data=" ",
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=52
                    ),
                ),
                Token(
                    type=TokenType.STRING_LITERAL,
                    data='"Kochava"',
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=53
                    ),
                ),
                Token(
                    type=TokenType.CLOSE_PAREN,
                ...
                Token(
                    ...
                    data="{",
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=64
                    ),
                ),
                Token(
                    type=TokenType.WHITESPACE,
                    data="\n\n            ",
                    source_location=SourceLocation(
                        file_name="<unnamed>", line_number=15, column_number=65
                    ),
                ),
                Token(
                    type=TokenType.IF_KEYWORD,
